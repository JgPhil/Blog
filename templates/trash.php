    ...
    <nav class="navbar navbar-expand-lg">
        <div class="row">
            <ul class="navbar-nav navbar-dark mx-auto">
                <li class="nav-item"><a class="nav-link" href=<?=htmlentities(INDEX_PATH).htmlentities(SLUG).'administration'?>><i class="fas fa-long-arrow-alt-left"></i> Retour à l'administration</a></li>
