    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="content">
          ...
          <<<<<<< HEAD <img src=<?= !empty($postPicture) ? POST_PICTURE . $postPicture->getName() : POST_EMPTY_PICTURE //htmlentities($picturePath['path']) 
                                ?> alt="<?= "une image de l'article " . $post->getTitle() ?>" class="img-fluid rounded float-left mr-5 mb-4">
            =======
